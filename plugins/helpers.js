export default ({ app }, inject) => {
  ...
  inject('currencyText', (num, digitOptions = { minimumFractionDigits: 2, maximumFractionDigits: 2 }) => {
  ...
  inject('telText', (tel) => {
    return tel.length === 10 ? tel.substr(0, 3) + ' ' + tel.substr(3, 3) + ' ' + tel.substr(6, 4) : tel
  })
